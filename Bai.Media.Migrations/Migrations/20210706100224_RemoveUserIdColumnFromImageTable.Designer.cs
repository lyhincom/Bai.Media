...
namespace Bai.Media.Migrations.Migrations
{
    ...
    [Migration("20210706100224_RemoveUserIdColumnFromImageTable")]
    partial class RemoveUserIdColumnFromImageTable
    {
            ...
            modelBuilder.Entity("Bai.Media.DAL.Models.ImageEntity", b =>
                {
                    ...
                    b.HasIndex("PageId", "PageType")
                        .HasDatabaseName("IX_Image_Key");

                    b.HasIndex("PageId", "PageType", "ImageGroupId", "Priority")
                        .HasDatabaseName("IX_Image_ImageGroupPriority");

                    b.HasIndex("PageId", "PageType", "FileExtension", "FileSizeInBytes", "CreatedDt", "Deleted")
